...
import 'package:eyesos/features/root/widgets/profile/personal_information_sheet.dart';
import 'package:eyesos/features/root/widgets/profile/profile_avatar_widgets.dart';
import 'package:eyesos/features/root/widgets/profile/profile_menu_card.dart';
import 'package:eyesos/features/root/widgets/profile/show_about_dialog_widget.dart';
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        // Phone Number (only for authenticated users)
                        if (isAuthenticated)
                          BlocSelector<SessionBloc, SessionState, String>(
                            selector: (state) {
                              if (state is AuthAuthenticated) {
